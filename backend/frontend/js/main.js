document.addEventListener('DOMContentLoaded', () => {
    ...
    const displayHourlyChart = (hourlyData) => {
        ...
        hourlyChart = new Chart(ctx, { type: 'line', data: { labels: labels, datasets: [{ label: 'Temperature', data: temperatures, fill: true, borderColor: chartColor, backgroundColor: 'rgba(74, 144, 226, 0.1)', tension: 0.4, pointRadius: 0 }] }, options: { responsive: true, maintainAspectRatio: false, plugins: { legend: { display: false } }, scales: { y: { beginAtZero: false, ticks: { color: chartColor, callback: function(value) { return value + '°'; } }, grid: { color: gridColor } }, x: { grid: { display: false }, ticks: { color: chartColor } } } } });
    };
